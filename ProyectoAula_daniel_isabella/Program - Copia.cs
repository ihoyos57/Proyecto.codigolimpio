    ...
    class Program
    {
        static void Main()
        {
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine(total_costos_por_eps(listaPersonas));
                    Console.WriteLine(porcentaje_costos_por_eps(listaPersonas));

                    Console.WriteLine(CalcularEdades(listaPersonas));
                    Console.WriteLine("el porcentaje de los niños es {0}:", CalcularEdades(listaPersonas));
                    Console.WriteLine(CalcularEdades(listaPersonas));
        ...
        //static List<double> porcentaje_por_afiliación (List<double> listaPersonas)
        //{
