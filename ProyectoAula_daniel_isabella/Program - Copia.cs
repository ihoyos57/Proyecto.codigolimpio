...
class Program
{
    static void Main()
    {
        ...
        while (true)
        {
            ...
            {
                Console.WriteLine("El costo total por cada eps es ", total_costos_por_eps(listaPersonas));
                Console.WriteLine("El porcentaje de costos por la eps selecionada es", porcentaje_costos_por_eps(listaPersonas));
                List<double> lista_edades = CalcularEdades(listaPersonas);
                Console.WriteLine("el porcentaje de los niños es {0}:", lista_edades);
                Console.WriteLine("el porcentaje de los adolecentes es {1}:", lista_edades);
                Console.WriteLine("el porcentaje de los jovenes es {2}:", lista_edades);
                Console.WriteLine("el porcentaje de los adultos es {3}:", lista_edades);
                Console.WriteLine("el porcentaje de los adultos mayores es {4}:", lista_edades);
                Console.WriteLine("el porcentaje de los ancianos es {5}:", lista_edades);
                Console.WriteLine(total_cancer(listaPersonas));
    ...
    private static Paciente Crear_paciente()
    {
        ...
        while (tipo_afiliacion == 0)
        {
            try
            {
                Console.WriteLine("Ingrese el tipo de régimen (1: Cotizante, 2: Beneficiario):");
